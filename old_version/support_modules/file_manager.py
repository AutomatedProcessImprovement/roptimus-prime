...
from new_version.data_structures.solution_space import SolutionSpace, DeviationInfo
from new_version.data_structures.solution_space import ResourceInfo
...
temp_bpmn_file = '../update_1/test_assets/CopiedModel.bpmn'

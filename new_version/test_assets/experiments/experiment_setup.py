...
experiments_file_paths = {
    ...
    'purchasing_example': [bfp + "purchasing_example/timetable.json",
                           ...
                           bfp + "purchasing_example/Purchasing_Example.bpmn"],
    'government': [bfp + "government/timetable.json",
                   bfp + "government/constraints.json",
                   bfp + "government/Government.bpmn"],
    'financial': [bfp + "financial/timetable.json",
                  bfp + "financial/constraints.json",
                  bfp + "financial/Financial.bpmn"],
    'consulta_data_mining': [bfp + "consulta_data_mining/timetable.json",
                             bfp + "consulta_data_mining/constraints.json",
                             bfp + "consulta_data_mining/Consulta_Data_Mining.bpmn"],
